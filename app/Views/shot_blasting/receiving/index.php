...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    ...
    <h5 class="mb-0 text-muted">RECEIVING (Hasil Proses Internal)</h5>
  </div>
  <form method="get" action="<?= site_url('/shot-blasting/receiving') ?>" class="d-flex align-items-center gap-2">
