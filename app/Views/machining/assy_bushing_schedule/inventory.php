...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0 fw-bold text-primary">STOCK INVENTORY - ASSY BUSHING</h4>
        <small class="text-muted">Total Stock di station Assy Bushing (Per <?= esc($titleDate) ?>)</small>
    </div>
    
    <div>
        <a href="<?= base_url('machining/assy-bushing/schedule?date='.$date) ?>" class="btn btn-outline-secondary btn-sm fw-bold">
            ...
            <table class="table table-hover table-striped align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Part Name</th>
                        <th style="width: 200px;" class="text-end">Total Stock di Assy Bushing</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if(empty($productData)): ?>
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted">
                                ...
                                Tidak ada stock tersedia di area Assy Bushing.
                            </td>
                        </tr>
                    <?php else: ?>
