...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 gap-2">
  ...
  <div>
      <a href="<?= base_url('machining/assy-bushing/schedule/inventory?date='.$date) ?>" class="btn btn-primary fw-bold btn-sm rounded-pill px-3">
        <i class="bi bi-box-seam me-1"></i> Stock Area Assy Bushing
      </a>
  </div>
</div>
