...
.production-table th,.production-table td{font-size:13px;padding:8px 8px;white-space:nowrap;text-align:center;vertical-align:middle;box-sizing:border-box;line-height:1.2;background:#fff}
        ...
        <thead>
          <tr class="thead-row-1">
            ...
            <?php foreach ($shift['slots'] as $slot): ?>
              <th colspan="4" class="slot-header" data-start="<?= esc($slot['time_start']) ?>" data-end="<?= esc($slot['time_end']) ?>">
