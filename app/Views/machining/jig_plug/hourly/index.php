...
<h4 class="mb-3">JIG PLUG – DAILY PRODUCTION PER HOUR</h4>
...
<form method="post" action="/machining/jig-plug/hourly/store" id="hourlyForm">
  <?= csrf_field() ?>
...
async function akhiriDandori(date, shiftId, machineId, timeSlotId) {
    ...
    try {
        ...
        const res = await fetch('<?= site_url('machining/jig-plug/hourly/endDandori') ?>', {
            method: 'POST',
            body: formData,
            headers: {
