...
<h4 class="mb-3">MACHINING - JIG PLUG DAILY PRODUCTION PER SHIFT</h4>
...
<form method="post" action="/machining/jig-plug/daily-production-achievement/store" id="mainFormShift">
    <?= csrf_field() ?>
