...
<form method="post" action="/machining/leak-test/hourly/store">
<?= csrf_field() ?>
...
<td class="sticky-left text-center fw-bold">
...
function calcTotals(){
 document.querySelectorAll('.production-table').forEach(t=>{
  ...
  summary.querySelector('.total-fg').innerText=ok
