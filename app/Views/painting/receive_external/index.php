...
<h4 class="mb-3">
    <i class="bi bi-box-arrow-in-down me-2"></i> Penerimaan Painting dari External
</h4>

<form method="post" action="/painting/receive-external/store" class="card p-3">
<?= csrf_field() ?>
...
<div class="row g-2">
    ...
    <div class="col-md-2">
        <button class="btn btn-success w-100">Terima</button>
    </div>
</div>
</form>
