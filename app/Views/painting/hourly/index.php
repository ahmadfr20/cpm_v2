...
<h4 class="mb-3">PAINTING – DAILY PRODUCTION PER HOUR</h4>
...
<form method="post" action="/painting/hourly/store" id="hourlyForm">
  <?= csrf_field() ?>
...
async function akhiriDandori(date, shiftId, machineId, timeSlotId) {
    ...
    try {
        ...
        const res = await fetch('<?= site_url('painting/hourly/endDandori') ?>', {
            method: 'POST',
            body: formData,
            headers: {
